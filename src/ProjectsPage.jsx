...
const PROJECTS = [
  {
    ...
    tags: ["React", "CSS", "UI Design", "Vite"],
    status: "LIVE",
    year: "2025",
    description: [
      "A Persona 3-inspired personal portfolio built with React and Vite.",
      "Features animated page transitions, custom UI components, and keyboard navigation.",
      "Designed from scratch with a JRPG game aesthetic.",
    ],
    link: "#",
  },
  {
    ...
    badge: "02",
    title: "PROJECT TWO",
    subtitle: "Python / Insert Tech Here",
    tags: ["Python", "Your", "Tech", "Here"],
    status: "COMPLETE",
    year: "2024",
    description: [
      "Replace this with your second project description.",
      "What problem did it solve? What makes it interesting?",
      "Link it below by replacing the # in the link field.",
    ],
    link: "#",
  },
  {
    ...
    year: "2025",
    description: [
      "Replace this with your third project description.",
      "Cool features, challenges you overcame, things you learned.",
      "Update the status field to match where you are.",
    ],
    link: "#",
  },
  {
    ...
    description: [
      ...
      "Add more PROJECTS objects above to show more work.",
    ],
    link: "#",
  },
];
  ...
  return (
    <div id="menu-screen">
      ...
      <div className="proj-entry-mask" aria-hidden="true">
        <video className="proj-entry-video" src={bgVideo} autoPlay loop muted playsInline preload="none" />
      </div>
      ...
      <style>{`
        ...
        .proj-entry-mask {
          ...
          animation: proj-entry-reveal 1.1s cubic-bezier(0.16,1,0.3,1) forwards;
          pointer-events: none;
        }
        .proj-entry-video {
        ...
        .proj-list-tag {
          ...
          color: #b47dff; letter-spacing: 2px;
          margin: 0 0 6px 12px;
        ...
        .proj-badge-text {
          ...
          color: #d9b8ff; letter-spacing: 1px; transform: rotate(8deg);
        }
        ...
        .proj-title {
          ...
          letter-spacing: 1px; color: #c899ff;
        ...
        .proj-year {
          ...
          letter-spacing: 2px; color: #a57dff;
          transition: color 0.22s; flex-shrink: 0; margin-top: 4px;
        }
        ...
        .proj-subtitle {
          ...
          line-height: 1; letter-spacing: 1px; color: #e8d4ff;
          transition: color 0.22s;
        }
        ...
        .proj-detail-panel::before {
          ...
          background:
            linear-gradient(135deg, rgba(180,125,255,0.07) 0 15%, transparent 15%),
        ...
        .proj-detail-top {
          ...
          min-height: 82px; padding: 0 16px;
          background: linear-gradient(90deg, #8b45ff 0%, #c28aff 100%);
          clip-path: polygon(0 0, 100% 0, calc(100% - 16px) 100%, 0 100%);
          color: #fff;
          box-shadow: 10px 0 0 rgba(220,50,180,0.5);
        }
        .proj-detail-top-index {
          font-family: 'Anton', sans-serif; font-size: 42px; line-height: 1;
        }
        .proj-detail-top-title {
          font-family: 'Anton', sans-serif; font-size: 32px; line-height: 0.92; letter-spacing: 1px;
        }
        .proj-detail-status {
        ...
        .proj-tags {
          display: flex; gap: 8px; flex-wrap: wrap; margin-top: 14px; padding: 0 2px;
        }
        .proj-tag {
          font-family: 'Bebas Neue', sans-serif; font-size: 15px; letter-spacing: 2px;
          padding: 4px 12px;
          background: rgba(140,70,255,0.18); border: 1px solid rgba(180,125,255,0.35);
          color: #c899ff;
          clip-path: polygon(0 0, 100% 0, calc(100% - 6px) 100%, 0 100%);
        }
        ...
        .proj-detail-desc-title {
          ...
          letter-spacing: 2px; color: #b47dff; margin-bottom: 12px;
        }
        .proj-detail-bullet {
          font-family: 'Anton', sans-serif; font-size: 19px; line-height: 1.25;
          color: #e0d0ff; margin-bottom: 8px;
        }

        .proj-detail-link { margin-top: 16px; padding: 0 2px; }
        .proj-open-btn {
          font-family: 'Bebas Neue', sans-serif; font-size: 20px; letter-spacing: 3px;
          color: #000; background: #b47dff; border: none;
          padding: 10px 28px;
          clip-path: polygon(0 0, 100% 0, calc(100% - 10px) 100%, 0 100%);
      ...
      <div className="proj-overlay">
            ...
            >
              <div className="proj-card">
                <div className="proj-badge">
                  <div className="proj-badge-text">{proj.badge}</div>
                </div>
                <div className="proj-card-inner">
                  <div className="proj-title">{proj.title}</div>
                  <div className="proj-year">{proj.year}</div>
                </div>
                <div className="proj-subtitle-bar">
        ...
        <div className="proj-detail-panel">
          <div className="proj-detail-top">
            ...
            <div
              className="proj-detail-status"
              style={{ background: STATUS_COLORS[project.status] ?? "#888" }}
            >
              {project.status}
            </div>
          </div>
      ...
      <div className={`proj-footer${mounted ? " mounted" : ""}`}>
        ...
        <div className="proj-footer-row"><span className="proj-footer-key">↵</span><span>OPEN LINK</span></div>
